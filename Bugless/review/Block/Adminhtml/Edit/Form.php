 ...
 */
namespace Bugless\Review\Block\Adminhtml\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            'created_at',
            'date',
            ['date_format' => 'yyyy-MM-dd', 'time_format' => 'hh:mm:ss', 'label' => __('Created at'), 'required' => false, 'name' => 'created_at', 'style' => 'width :20em;']
        );
